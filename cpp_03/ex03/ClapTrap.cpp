...
{
    std::cout << "ClapTrap default construtor call" << std::endl;
    setAttackDamage(0);
    setEnergyPoint(10);
    setHitpoint(10);
    setName("UnknowName");
...
{
    std::cout << "ClapTrap construtor name call" << std::endl;
    setAttackDamage(0);
    setEnergyPoint(10);
    setHitpoint(10);
    setName(name);   
...
void    ClapTrap::myinfo(void)
{
        ...
        std::cout << "My Attack Damage : " << ClapTrap::getAttackDamage() << std::endl;
}
...
void    ClapTrap::beRepaired(unsigned int amount)
{
    if(ClapTrap::getHitpoint() == 0 || ClapTrap::getEnergyPoint() == 0)
    {
        std::cout << "Can't take Reparied." << std::endl;
        return;
    }  
    else
    {
