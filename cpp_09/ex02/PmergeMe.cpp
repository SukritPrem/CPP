...
template<typename Container, typename ContainPair, typename Type>
PmergeMe<Container, ContainPair, Type>::PmergeMe(){
    _haveOdd = false;
};

// template class PmergeMe<std::vector<int>,std::vector<std::pair<int,int> >, int>;
